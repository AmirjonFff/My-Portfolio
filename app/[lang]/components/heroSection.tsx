    ...
    return (
        <section className="container mt-10 mx-auto px-12 py-5 sm:py-14 md:py-16 lg:py-36">
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    <h1 className="text-white mb-4 leading-[2] lg:leading-[8] mt-3 font-extrabold">
                        <span className="text-transparent text-3xl md:text-4xl lg:text-7xl xl:text-8xl bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-600">
                            {heroSection.title}
                        </span>
                        <br></br>
                        <TypeAnimation
                            ...
                            speed={20}
                            repeat={Infinity}
                            className="text-[25px] md:text-[35px] lg:text-7xl xl:text-8xl"
                        />
                    </h1>
