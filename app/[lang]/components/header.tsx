...
export default async function Header({ lang }: { lang: Locale }) {
  ...
  return (
    <header className="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#100e2b] bg-opacity-100">
      <div className="flex container lg:py-[14px] flex-wrap items-center justify-between mx-auto px-10 py-2">
        ...
        <div className='hidden md:block'><MenuCustomList /></div>
